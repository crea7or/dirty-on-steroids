...
d3.addModule(
{
	...
	config: {
		active:{type:'checkbox',value:0, description: 'Если в посте есть комментарии с картинками, то сверху страницы появляется полоска с копиями всех картинок, масштабированными в одну высоту.'},
